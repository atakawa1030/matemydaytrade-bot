...
// ==========================================
// 🚀 เริ่มต้นการทำงาน (ตั้งเวลา Cron Jobs แยก Timeframe)
// ==========================================
console.log("🚀 Matemydaytrade Auto-Signal Bot Started!");

// 1. เช็กกราฟ 5 นาที (ทำงานทุกๆ นาทีที่หารด้วย 5 ลงตัว เช่น 10:05, 10:10)
cron.schedule('*/5 * * * *', () => {
    checkSignal('5min');
});

// 2. เช็กกราฟ 15 นาที (ทำงานทุกๆ นาทีที่หารด้วย 15 ลงตัว)
cron.schedule('*/15 * * * *', () => {
    checkSignal('15min');
});

// 3. เช็กกราฟ 1 ชั่วโมง (ทำงานตอนต้นชั่วโมงพอดี เช่น 10:00, 11:00)
cron.schedule('0 * * * *', () => {
    checkSignal('1h');
});

// 4. เช็กกราฟ 4 ชั่วโมง (ทำงานทุกๆ 4 ชั่วโมง)
cron.schedule('0 */4 * * *', () => {
    checkSignal('4h');
});